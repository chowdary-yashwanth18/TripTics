...
def generate_universal_destination(place_name):
    ...
    using the Wikipedia API and deterministic hashing. Falls back to a generic description
    ...
    title = place_name
    extract = f"A beautiful destination located in {title}."
    ...
    try:
        ...
        print("Universal Generator Wikipedia Fetch Error:", e)
        # We continue even on error to ensure ANY location works!
    ...
    try:
        ...
        print("Universal Generator Logic Error:", e)
        return None
